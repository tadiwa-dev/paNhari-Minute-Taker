...
app.on("meeting.end" as any, async ({ activity, send }: { activity: any; send: any }) => {
  try {
    ...
    logger.debug(`🏁 Meeting ended: ${meetingId}. Fetching transcripts...`);
